...
var _flowusclient = require('@flowusx/flowus-client');
var _flowustomd = require('@flowusx/flowus-to-md');
...
function getPropVal(type, val, pageTitle) {
  ...
  switch (type) {
    ...
    case "phone":
      return val.text;
    case "file":
      _shared.out.debug(`\u3010${pageTitle}\u3011\u5B58\u5728\u6682\u4E0D\u652F\u6301\u7684\u5C5E\u6027\u7C7B\u578B:\u3010\u6587\u4EF6\u5A92\u4F53\u3011, \u5EFA\u8BAE\u5C06\u5176\u4E0A\u4F20\u5230\u56FE\u5E8A\u540E\u4F7F\u7528`);
      return "";
    case "checkbox":
      return val.text === "YES";
    case "formula":
      _shared.out.debug(`\u3010${pageTitle}\u3011\u5B58\u5728\u6682\u4E0D\u652F\u6301\u7684\u5C5E\u6027\u7C7B\u578B:\u3010\u516C\u5F0F\u3011`);
      return "";
    case "date":
      return _shared.timeFormat.call(void 0, val.startDate + " " + val.startTime);
    case "multi_select":
      return val.text.split(",");
    case "person":
      _shared.out.debug(`\u3010${pageTitle}\u3011\u5B58\u5728\u6682\u4E0D\u652F\u6301\u7684\u5C5E\u6027\u7C7B\u578B:\u3010\u4EBA\u5458\u3011`);
      return "";
    default:
      return val.text || "";
  }
...
function props(pageBlock, tableBlock) {
  ...
  properties.updated = _shared.timeFormat.call(void 0, pageBlock.updatedAt);
  properties.date = _shared.timeFormat.call(void 0, pageBlock.createdAt);
...
function genCatalog(page, property) {
  ...
  if (!catalog) {
    _shared.out.warning(`${page.properties.title} ${property} \u5C5E\u6027\u7F3A\u5931`);
    return void 0;
    ...
    _shared.out.warning(`${page.properties.title} \u6587\u6863\u5206\u7C7B\u4FE1\u606F\u63D0\u53D6\u5931\u8D25\uFF0C${property} \u5B57\u6BB5\u53EA\u80FD\u662F\u5355\u9009/\u591A\u9009`);
    return void 0;
  }
}
  ...
  return docs.sort((a, b) => {
    if (sorts) {
      ...
      if (Number.isNaN(Number(aSortValue)) || Number.isNaN(Number(bSortValue))) {
        if (_shared.isTime.call(void 0, aSortValue) && _shared.isTime.call(void 0, bSortValue)) {
          aSortValue = _shared.getTimes.call(void 0, aSortValue);
          bSortValue = _shared.getTimes.call(void 0, bSortValue);
        } else {
          return -1;
        }
      } else {
...
var FlowUsClient = class {
  constructor(config) {
    ...
    if (!this.config.tablePageId) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11 Table Page ID");
      process.exit(-1);
    }
    this.flowus = new (0, _flowusclient.FlowUsClient)();
    this.f2m = new (0, _flowustomd.FlowUsToMarkdown)({ client: this.flowus });
  ...
  initCatalogConfig() {
    if (typeof this.config.catalog === "boolean") {
      if (!this.config.catalog) {
        ...
        _shared.out.access("\u5F00\u542F\u5206\u7C7B", "\u9ED8\u8BA4\u6309\u7167 catalog \u5B57\u6BB5\u5206\u7C7B\uFF0C\u8BF7\u68C0\u67E5FlowUs\u591A\u7EF4\u8868\u662F\u5426\u5B58\u5728\u8BE5\u5C5E\u6027");
      ...
      if (this.config.catalog.enable) {
        if (!this.config.catalog.property) {
          ...
          _shared.out.warning("\u672A\u8BBE\u7F6E\u5206\u7C7B\u5B57\u6BB5\uFF0C\u9ED8\u8BA4\u6309\u7167 catalog \u5B57\u6BB5\u5206\u7C7B\uFF0C\u8BF7\u68C0\u67E5FlowUs\u591A\u7EF4\u8868\u662F\u5426\u5B58\u5728\u8BE5\u5C5E\u6027");
        }
      }
    }
  }
  ...
  getPageList() {
    return __async(this, null, function* () {
      ...
      blocks = yield this.flowus.getOssUrl(blocks);
  ...
  download(page) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        _shared.out.warning(`${page.title} \u4E0B\u8F7D\u51FA\u9519: ${e.message}`);
        _shared.out.debug(e);
      }
      const doc = {
        id: page.id,
  ...
  getPageDetailList(cachedPages, ids) {
    return __async(this, null, function* () {
      ...
      if (ids == null ? void 0 : ids.length) {
        pages = pages.filter((page) => {
          ...
          if (!exist) {
            ...
            _shared.out.info("\u8DF3\u8FC7\u4E0B\u8F7D", title);
          }
          return exist;
        });
      }
      if (!(pages == null ? void 0 : pages.length)) {
        _shared.out.info("\u8DF3\u8FC7", "\u6CA1\u6709\u9700\u8981\u4E0B\u8F7D\u7684\u6587\u7AE0");
        return articleList;
      }
      _shared.out.info("\u5F85\u4E0B\u8F7D\u6570", String(pages.length));
      ...
      const promise = (page) => __async(this, null, function* () {
        _shared.out.info(`\u4E0B\u8F7D\u6587\u6863 ${page._index}/${pages.length}   `, page.title);
        let article = yield this.download(page);
        articleList.push(article);
      });
      yield _tinyasyncpool2.default.call(void 0, this.config.limit || 3, pages, promise);
