...
var _api = require('@feishux/api');
var _doctomd = require('@feishux/doc-to-md');
...
var getProps = (page, body) => {
  let properties = {
    ...
    urlname: page.doc_id,
    // 创建时间
    date: _shared.timeFormat.call(void 0, page.createdAt),
    // 更新时间
    updated: _shared.timeFormat.call(void 0, page.updatedAt)
  };
  try {
    const regex = /^---[\s|\S]+?---/i;
...
var FeiShuClient = class {
  constructor(config) {
    ...
    if (!this.config.appId || !this.config.appSecret) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11\u6587\u4EF6\u5939Token\u6216\u77E5\u8BC6\u5E93 ID");
      process.exit(-1);
    }
    if (config.type === "wiki" && !config.wikiId) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11\u77E5\u8BC6\u5E93ID");
      process.exit(-1);
    } else if ((!config.type || config.type === "space") && !config.folderToken) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11\u6211\u7684\u7A7A\u95F4\u4E2D\u6587\u4EF6\u5939 ID");
      process.exit(-1);
    }
    this.feishu = new (0, _api.FeiShuClient)({
      appId: this.config.appId,
      appSecret: this.config.appSecret,
      baseUrl: this.config.baseUrl
    });
    this.f2m = new (0, _doctomd.FeiShuToMarkdown)();
  }
  getPageList() {
