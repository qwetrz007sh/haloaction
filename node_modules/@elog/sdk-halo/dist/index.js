...
var _formstream = require('formstream'); var _formstream2 = _interopRequireDefault(_formstream);
var HaloClient = class {
  constructor(config) {
    this.config = config;
    if (!config.endpoint) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11Halo\u7AD9\u70B9\u5730\u5740 endpoint");
      process.exit(-1);
    }
    if (!this.config.token) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11Halo\u4E2A\u4EBA\u4EE4\u724C token");
      process.exit(-1);
    }
    if (!this.config.policyName) {
      _shared.out.warning("\u6CE8\u610F", "\u672A\u6307\u5B9A\u5B58\u50A8\u7B56\u7565\uFF0C\u5C06\u4F7F\u7528\u9ED8\u8BA4\u7B56\u7565\u4E0A\u4F20\u56FE\u7247");
  ...
  uploadAttachment(buffer, filename) {
    return __async(this, null, function* () {
      const form = new (0, _formstream2.default)();
...
// src/types.ts
var _apiclient = require('@halo-dev/api-client');
...
exports.Content = _apiclient.Content; exports.Post = _apiclient.Post; exports.PostRequest = _apiclient.PostRequest; exports.PostSpecVisibleEnum = _apiclient.PostSpecVisibleEnum; exports.default = src_default;
