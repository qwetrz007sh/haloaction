...
var _notiontomd = require('notion-to-md');
...
function getPropVal(data) {
  ...
  switch (data.type) {
    ...
    case "select":
      return val.name;
    case "date":
      return _shared.timeFormat.call(void 0, val.start);
    case "rich_text":
    case "title":
...
function props(page) {
  ...
  if (!properties.title) {
    ...
    properties.title = titleVal.map((a) => a.plain_text).join("");
  }
  if (!properties.urlname) {
    properties.urlname = page.id;
  }
  if (!properties.date) {
    properties.date = _shared.timeFormat.call(void 0, page.created_time);
  }
  if (!properties.updated) {
    properties.updated = _shared.timeFormat.call(void 0, page.last_edited_time);
  }
  return properties;
}
...
var NotionClient = class {
  constructor(config) {
    ...
    if (!this.config.token) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11 Notion Token");
      process.exit(-1);
    }
    if (!this.config.databaseId) {
      _shared.out.err("\u7F3A\u5C11\u53C2\u6570", "\u7F3A\u5C11Notion \u6570\u636E\u5E93 ID");
      process.exit(-1);
    }
    ...
    this.notion = new (0, _client.Client)({ auth: this.config.token });
    this.n2m = new (0, _notiontomd.NotionToMarkdown)({
  ...
  initCatalogConfig() {
    if (typeof this.config.catalog === "boolean") {
      if (!this.config.catalog) {
        ...
        _shared.out.access("\u5F00\u542F\u5206\u7C7B", "\u9ED8\u8BA4\u6309\u7167 catalog \u5B57\u6BB5\u5206\u7C7B\uFF0C\u8BF7\u68C0\u67E5Notion\u6570\u636E\u5E93\u662F\u5426\u5B58\u5728\u8BE5\u5C5E\u6027");
      ...
      if (this.config.catalog.enable) {
        if (!this.config.catalog.property) {
          ...
          _shared.out.warning("\u672A\u8BBE\u7F6E\u5206\u7C7B\u5B57\u6BB5\uFF0C\u9ED8\u8BA4\u6309\u7167 catalog \u5B57\u6BB5\u5206\u7C7B\uFF0C\u8BF7\u68C0\u67E5Notion\u6570\u636E\u5E93\u662F\u5426\u5B58\u5728\u8BE5\u5C5E\u6027");
        }
      }
    }
  }
  ...
  download(page) {
    return __async(this, null, function* () {
      ...
      if (!blocks.length) {
        _shared.out.warning(`${page.properties.title} \u6587\u6863\u4E0B\u8F7D\u8D85\u65F6\u6216\u65E0\u5185\u5BB9 `);
      }
      let body = ((_a = this.n2m.toMarkdownString(blocks)) == null ? void 0 : _a.parent) || "";
  ...
  getPageDetailList(cachedPages, ids) {
    return __async(this, null, function* () {
      ...
      const promise = (page) => __async(this, null, function* () {
        _shared.out.info(`\u4E0B\u8F7D\u6587\u6863 ${page._index}/${pages.length}   `, page.properties.title);
