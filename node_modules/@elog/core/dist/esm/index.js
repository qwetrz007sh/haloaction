...
import NotionClient from "@elog/sdk-notion";
import FlowUsClient from "@elog/sdk-flowus";
import FeiShuClient from "@elog/sdk-feishu";
import DeployClient, { DeployPlatformEnum } from "@elog/deploy";
...
var Elog = class {
  ...
  syncForced() {
    var _a, _b;
    if (((_a = this.wasteArticles) == null ? void 0 : _a.length) && ((_b = this.cachedArticles) == null ? void 0 : _b.length) && this.config.deploy.platform === DeployPlatformEnum.LOCAL) {
      out.warning("\u6587\u6863\u5F3A\u5236\u540C\u6B65\u4E2D...");
