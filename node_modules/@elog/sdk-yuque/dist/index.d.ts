...
interface YuqueDocListResponse {
    meta: {
        total: number;
    };
    data: YuqueDoc[];
...
interface YuqueLoginCookie {
    data: string;
    time: number;
}

type FormatExtConfig = ((doc: DocDetail) => string) | string | boolean;
interface YuqueWithTokenConfig {
    /**
...
declare class YuqueClient$1 {
     ...
     * @param custom
     */
    request<T>(api: string, reqOpts: RequestOptions, custom?: boolean): Promise<T>;
    /**
     * 获取目录
     */
...
declare class YuqueClient {
     ...
     * 获取文章详情
     */
    getDocDetail(slug: string): Promise<any>;
    /**
     * 获取文章详情列表
     * @param cachedDocs
     * @param ids
...
export { DocUnite, FormatExtFunction, GetProps, YuQueResponse, YuqueBook, YuqueDoc, YuqueDocDetail, YuqueDocListResponse, YuqueDocProperties, YuqueLogin, YuqueUser, YuqueWithPwd, YuqueWithPwdConfig, YuqueWithToken, YuqueWithTokenConfig };
